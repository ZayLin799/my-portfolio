...
const Main = () => {
  return (
    <section id="home" className="w-full h-screen relative flex items-center justify-center overflow-hidden pt-20 sm:pt-0">
      ...
      <div className="max-w-[1240px] w-full mx-auto px-6 z-10 mt-16 sm:mt-0">
        <div className="flex flex-col items-center justify-center text-center space-y-8">
          <div className="animate-float w-full max-w-full overflow-hidden px-4">
            <p className="px-3 py-1 rounded-full glass border border-primary/20 text-[9px] min-[375px]:text-[10px] sm:text-xs md:text-sm font-bold tracking-[0.1em] min-[375px]:tracking-[0.2em] sm:tracking-[0.3em] text-primary uppercase inline-block max-w-full whitespace-normal">
