    ...
    <div className="w-full">
      <div className="w-screen h-[50vh] relative">
        ...
        <Image
          ...
          src={jpImg}
          alt="JP Auction Sheet"
          fill
          style={{ objectFit: 'cover' }}
          priority
        />
        <div className="absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-6">
          <h2 className="py-2 text-4xl sm:text-5xl md:text-6xl font-black tracking-tight">JP Auction Sheet</h2>
          <h3 className="text-primary font-bold tracking-widest uppercase text-sm">Laravel / PHP / Payment Gateways</h3>
        </div>
      </div>
      ...
      <div className="max-w-[1240px] mx-auto p-6 grid md:grid-cols-5 gap-12 py-16">
        <div className="col-span-1 md:col-span-4 space-y-6">
          ...
          <p className="text-lg text-slate-400 leading-relaxed max-w-3xl">
            JP Auction Sheet is a specialized platform helping car buyers and dealers verify vehicle condition
            using authentic Japanese auction sheets. Built with Laravel, it features a complex search engine,
            high-resolution image processing, and integration with multiple payment gateways including
            Stripe and local providers.
          </p>
          <div className="pt-4">
            <a
              href="https://jpauctionsheet.com/"
              target="_blank"
              rel="noreferrer"
            >
